...
export default function Login({ status, canResetPassword, canRegister, allowPasswordLogin }: { status?: string, canResetPassword?: boolean, canRegister?: boolean, allowPasswordLogin?: boolean }) {
