...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/trips/{trip}/itinerary', [\App\Http\Controllers\Web\ItineraryItemController::class, 'store'])->name('itinerary.store');
    Route::put('/itinerary/{itineraryItem}', [\App\Http\Controllers\Web\ItineraryItemController::class, 'update'])->name('itinerary.update');
    Route::delete('/itinerary/{itineraryItem}', [\App\Http\Controllers\Web\ItineraryItemController::class, 'destroy'])->name('itinerary.destroy');
